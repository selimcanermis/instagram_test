...
class Instagram:
    ...
    def logIn(self):
        ...
        loginbuttonInput = self.driver.find_element_by_xpath(
    ...
    def search(self, hashtag):
        ...
        searchInput = self.driver.find_element_by_class_name(
            "XTCLo").send_keys(self.hashtag, Keys.ENTER)
        time.sleep(3)
        searchAccount = self.driver.find_element_by_xpath(
            "//*[@id='react-root']/section/nav/div[2]/div/div/div[2]/div[4]/div/a[1]/div/div[2]")
    ...
    def watchStory(self):
        ...
        stories = self.driver.find_element_by_xpath(
    ...
    def userStats(self):
        ...
        if(self.is_public == True):
            ...
            if(self.is_following == True):
                ...
                self.warningMessage("Kullanıcı...:   " +
                                    userName + " (Takip ediliyor) ", 3)
    ...
    # ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔
    # takip edilip edilmeme kontrolü yapan fonksiyon yapisi
    def isFollowing(self):
        follow_button = self.driver.find_element_by_xpath(
            "//*[@id='react-root']/section/main/div/header/section/div[1]/div[2]/div/div/div/span/span[1]/button").text
    ...
    # ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔ ✔
    # kullanıcı ismi isteyerek takip ettiklerinin listesini veren fonksiyon yapisi
    def followingList(self):

        _user = input("Aradığınız kullanıcı: ")
        self.search(_user)
        print("-"*50)
        self.warningMessage("Kullanıcı bulundu.", 1)
        print("-"*50)
    ...
    def myProfilStats(self):
        ...
        self.warningMessage("Kullanıcı...:   " + userName , 3)
        print("Gönderi.....:   " + posts_numbers)
        print("Takipçi.....:   " + followers_numbers)
        print("Takip.......:   " + following_numbers)
        self.warningMessage("Basarili................", 1)
    ...
    def Menu(self):
        while True:
            ...
            print("#            7- Kendi Profil İstatistiklerin\u2714    #")
            print("#            8- Çıkış Yap \u2714                      #")
            print("#            9- url kontrol \u2714                    #")
            print("#            10- follow \u2714                        #")
            print("#            11- unfollow                        #")
            ...
            # toplu follow
                ...
                follow_list = ["ozan", "dimitrispelkas", "merthakanyandas",
                               "fcbayern", "fenerbahce", "laclippers"]
